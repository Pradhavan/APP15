        ...
        <div className='unijourneyContainer' >
            ...
            <div className="journet__content">
                ...
                <div className="journeyContainer-left">
                    ...
                    <p>Hive Steps presents the future development platform to
                        develop communication skills and a strategic mindset
                        to bridge the professional gap between campus and
                        corporate for students.</p>
                    ...
                    <div className="journey__steps">
                        ...
                        <div className="journeyStep">
                            ...
                            <div className="stepContent">
                                ...
                                <p>Learn from global educators in your
                                    interest fields</p>
                            </div>
                        </div>
